...
namespace SQLUserCreate
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //授权
            var guser1sql = "GRANT SELECT ON client.*TO 'test1'@'localhost' IDENTIFIED BY '1234'";
            var guser2sql = "GRANT SELECT, INSERT ON client.*TO 'test1'@'localhost' IDENTIFIED BY '1234'";
            var guser3sql = "GRANT SELECT, INSERT, UPDATE ON client.*TO 'test1'@'localhost' IDENTIFIED BY '1234'";
            var guser4sql = "GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, DROP ON client.*TO 'test1'@'localhost' IDENTIFIED BY '1234'";
            //回收权限
            var ruser1sql= "revoke all ON client.* from 'test1' @'localhost'";
